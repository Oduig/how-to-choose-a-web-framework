...
## About
I am a software engineer at a consultancy bureau in Eindhoven (The Netherlands). Lately, we see more and more customers coming our way asking for experience in web technology, and we wanted to expand our knowledge in the area. The reason for this article is to simplify the decision making process, and provide a framework for future projects and new developers.

Most of the information here is available in other places, but it is often fragmented, narrowly focused and biased. I have expressly tried *not* to promote a particular technology simply because I like it. The truth is, I can almost guarantee that one of the technologies you choose is going to be obsolete in less than 10 years. The upside is that if you read all of this, you know why you made the decision and what you can look for in a good replacement.
